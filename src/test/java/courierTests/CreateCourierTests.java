...
public class CreateCourierTests {
    ...
    @Description("Проверка создание нового курьера и что его можно создать")
    ...
    @Description("Проверка ошибки создания курьера с ранее зарегистрированным логином")
    ...
    @Description("Проверка ошибки создания курьера без логина")
    ...
    @Description("Проверка ошибки создания курьера без пароля")
    ...
    @Description("Проверка ошибки создания курьера без ввода логина и  пароля")
