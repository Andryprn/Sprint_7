...
public class LoginCourierTests {
    ...
    @Description("Проверка, что курьер может войти в систему с валидными данными")
    ...
    @Description("Проверка ошибки входа в систему с пустым полем логина")
    ...
    @Description("Проверка ошибки входа в систему с пустым полем пароля")
    ...
    @Description("Проверка ощибки входа в систему с пустыми полями логина и пароля")
    ...
    @Description("Проверка ошибки входа в систему с ранее не зарегистрированным логином")
